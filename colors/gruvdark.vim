...
" Last Updated: Tue Dec 22 19:57:04 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if has('nvim')
    ...
    let g:terminal_color_12 = '#8f98af'
  ...
  hi StorageClass guifg=#8f98af guibg=NONE gui=bold,italic cterm=bold,italic
  ...
  hi Directory guifg=#8f98af guibg=NONE gui=NONE cterm=NONE
  ...
  hi Constant guifg=#d3869b guibg=NONE gui=bold cterm=bold
  hi Error guifg=#e9593d guibg=#ebdbb2 gui=bold,reverse cterm=bold,reverse
  hi Identifier guifg=#8f98af guibg=NONE gui=bold cterm=bold
  ...
  hi netrwDoc guifg=#8f98af guibg=NONE gui=NONE cterm=NONE
  ...
  hi mkdDelimiter guifg=#8f98af guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi StorageClass ctermfg=104 ctermbg=NONE cterm=bold,italic
  ...
  hi Directory ctermfg=104 ctermbg=NONE cterm=NONE
  ...
  hi Constant ctermfg=217 ctermbg=NONE cterm=bold
  hi Error ctermfg=202 ctermbg=187 cterm=bold,reverse
  hi Identifier ctermfg=104 ctermbg=NONE cterm=bold
  ...
  hi netrwDoc ctermfg=104 ctermbg=NONE cterm=NONE
  hi! link BufTabLineCurrent PmenuSel
  hi! link BufTabLineActive TabLineSel
  hi! link BufTabLineHidden TabLine
  hi! link BufTabLineFill TabLineFill
  ...
  hi! link mkdBlockquote mkdURL
  hi mkdDelimiter ctermfg=104 ctermbg=NONE cterm=NONE
