...
" Last Updated: Thu Dec 17 10:01:23 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi mkdURL guifg=#8f8880 guibg=NONE gui=italic cterm=italic
  hi mkdDelimiter guifg=#8098af guibg=NONE gui=italic cterm=italic
  ...
  if !s:italics
    ...
    hi mkdURL gui=NONE cterm=NONE
    hi mkdDelimiter gui=NONE cterm=NONE
  endif
...
if s:t_Co >= 256
  ...
  hi Delimiter ctermfg=203 ctermbg=NONE cterm=italic
  ...
  hi SpellRare ctermfg=203 ctermbg=NONE cterm=italic,underline
  ...
  hi! link mkdHeading mkdStrike
  hi mkdURL ctermfg=245 ctermbg=NONE cterm=italic
  hi mkdDelimiter ctermfg=109 ctermbg=NONE cterm=italic
  ...
  if !s:italics
    ...
    hi mkdURL cterm=NONE
    hi mkdDelimiter cterm=NONE
  endif
  unlet s:t_Co s:italics
  finish
endif
